...
import RendererWrapper0 from 'E:/q-Code/ant-design-pro-master/src/pages/.umi/LocaleWrapper.jsx';
...
const routes = [
  {
    ...
    component: __IS_BROWSER
      ? _dvaDynamic({
          ...
          LoadingComponent: require('E:/q-Code/ant-design-pro-master/src/components/PageLoading/index')
            .default,
        })
    ...
    routes: [
      ...
      },
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              ...
              models: () => [
                import('E:/q-Code/ant-design-pro-master/src/pages/User/models/register.js').then(
                  m => {
      ...
      },
      {
        component: () =>
          React.createElement(
            require('E:/q-Code/ant-design-pro-master/node_modules/_umi-build-dev@1.18.8@umi-build-dev/lib/plugins/404/NotFound.js')
              .default,
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        routes: [
          {
            path: '/new/newanalysis',
            name: 'newanalysis',
            component: __IS_BROWSER
              ? _dvaDynamic({
                  component: () => import('../New/NewAnalysis'),
                  LoadingComponent: require('E:/q-Code/ant-design-pro-master/src/components/PageLoading/index')
                    .default,
                })
              : require('../New/NewAnalysis').default,
            exact: true,
          },
          {
            path: '/new/analysis',
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/Dashboard/models/activities.js').then(
                      m => {
                        return { namespace: 'activities', ...m.default };
                      },
                    ),
                    import('E:/q-Code/ant-design-pro-master/src/pages/Dashboard/models/chart.js').then(
                      m => {
                        return { namespace: 'chart', ...m.default };
                      },
                    ),
                    import('E:/q-Code/ant-design-pro-master/src/pages/Dashboard/models/monitor.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/Forms/models/form.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/List/models/rule.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/Profile/models/profile.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/Exception/models/error.js').then(
                      m => {
          ...
          },
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('E:/q-Code/ant-design-pro-master/src/pages/Account/Settings/models/geographic.js').then(
                      m => {
