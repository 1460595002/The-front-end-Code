...
import findRoute, {
  getUrlQuery,
} from 'E:/q-Code/ant-design-pro-master/node_modules/_umi-build-dev@1.18.8@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/_umi-plugin-ui@1.5.3@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: 'E:/q-Code/ant-design-pro-master',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.18.8@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
